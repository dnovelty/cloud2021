...
spring:
  ...
  datasource:
    driver-class-name: com.mysql.jdbc.Driver  #链接mysql8以下
    #driver-class-name: com.mysql.cj.jdbc.Driver  #链接mysql8以上
    url: jdbc:mysql://localhost:3306/seata_storage?serverTimezone=Asia/Shanghai #mysql8需要带上时区
    username: root
    password: 123456
  cloud:
    alibaba:
